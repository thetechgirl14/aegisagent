...
[![Live Demo](https://img.shields.io/badge/Live%20Demo-Streamlit-34d399?style=flat-square)](https://thetechgirl14-aegisagent-dashboard-streamlit-app.streamlit.app)
...
**[→ Try the live interactive demo](https://thetechgirl14-aegisagent-dashboard-streamlit-app.streamlit.app)** — no login, no setup. Click "Run Benign Session", then "Inject Attack" and watch all three layers respond in real time.

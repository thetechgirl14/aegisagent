...
[![Live Demo](https://img.shields.io/badge/Live%20Demo-Railway-7B2FBE?style=flat-square)](https://aegisagent-thetechgirl.up.railway.app/)
...
**[→ Try the live interactive demo](https://aegisagent-thetechgirl.up.railway.app/)** — no login, no setup. Click "Run Benign Session", then "Inject Attack" and watch all three layers respond in real time.
